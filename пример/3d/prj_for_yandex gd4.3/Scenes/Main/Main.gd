...
func _on_AnimationPlayer_animation_finished(anim_name):
	if anim_name=="Sonya":
		...
		get_tree().change_scene_to_file("res://Scenes/Milina/Milina.tscn")
	elif anim_name=="Jade":
		get_tree().change_scene_to_file("res://Scenes/Jade/Jade.tscn")
	elif anim_name=="Kitana":
		get_tree().change_scene_to_file("res://Scenes/Kitana/Kitana.tscn")
	elif anim_name=="Sindel":
		get_tree().change_scene_to_file("res://Scenes/Sindel/Sindel.tscn")
	elif anim_name=="Tanya":
		get_tree().change_scene_to_file("res://Scenes/Tanya/Tanya.tscn")
	elif anim_name=="Frost":
		get_tree().change_scene_to_file("res://Scenes/Frost/Frost.tscn")
	elif anim_name=="Cetrion":
		get_tree().change_scene_to_file("res://Scenes/Cetrion/Cetrion.tscn")
	elif anim_name=="Skarlet":
		get_tree().change_scene_to_file("res://Scenes/Skarlet/Skarlet.tscn")
	elif anim_name=="Ferra":
		get_tree().change_scene_to_file("res://Scenes/Ferra/Ferra.tscn")
