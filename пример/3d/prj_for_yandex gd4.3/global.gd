...
#-------------------------------------------------------------------------------
signal ad(value)
var callback_ad = JavaScriptBridge.create_callback(Callable(self, '_ad'))
func js_show_ad():
...
var callback_foc_unfoc=JavaScriptBridge.create_callback(Callable(self, '_foc_unfoc'))
...
#-------------------------------------------------------------------------------
var callback_get_data=JavaScriptBridge.create_callback(Callable(self,'_get_data'))
